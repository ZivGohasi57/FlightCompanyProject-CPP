...
{
    if (maxWeightKg <= 0) maxWeightKg = 1;
...
int CCargo::getMaxWeight() const { return maxWeightKg; }
int CCargo::getMaxVolume() const { return maxVolume; }
int CCargo::getLoadedWeight() const { return loadedWeightKg; }
int CCargo::getLoadedVolume() const { return loadedVolume; }

CPlane* CCargo::Clone() const { return new CCargo(*this); }
